...
const Ru = [
  {
    id: 1,
    name: "Создайте портфолио веб-сайтов с помощью HTML, CSS и JS. ",
    tags: ["Html", "css", "js"],
    date: "1 июня, 2023",
  ...
  {
    id: 2,
    name: "Как создать простой веб-сайт-портфолио с помощью Html, Css, Js",
    tags: ["Html", "Css", "Js"],
    date: "10 июня, 2023",
    link: "https://mohamedayman22e.github.io/Portfolio/",
    type: "js",
  ...
  {
    id: 3,
    name: "Создайте веб-сайт React Академический опыт онлайн-образования ",
    tags: ["react", "Css"],
  ...
  {
    id: 5,
    name: "Создан веб-сайт агентства маркетинговых решений с помощью React ",
    tags: ["react", "css"],
    date: "8 июня, 2024",
  ...
  {
    id: 6,
    name: "Создал простой веб-сайт Wren с помощью Html css js",
    tags: ["HTML", "css", "Js"],
  ...
  {
    id: 7,
    name: "Создайте простую программу проверки надежности пароля с помощью Html css js",
  ...
  {
    id: 8,
    name: "Построен простой цикл прогресса на основе Html css js.",
    tags: ["Html", "css", "js"],
    date: "2 Декабря , 2023",
  ...
  {
    id: 9,
    name: "Создать пользовательское меню выбора с полем поиска с помощью Html css js",
    tags: ["Html", "css", "js"],
    date: "2 Декабря , 2023",
  ...
  {
    id: 10,
    name: "Создайте простой список дел с помощью Html css js",
    tags: ["Html", "css", "js"],
    date: "15 января, 2024",
  ...
  {
    id: 11,
    name: "Создайте простой Bolby Doe React-Portfolio-Sass с помощью React Scss js",
    tags: ["React", "scss"],
    date: "22 января, 2024",
  ...
  {
    id: 12,
    name: "Создайте простое приложение узла, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "24 января, 2024",
  ...
  {
    id: 13,
    name: "Создайте приложение для случайного пароля, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "9 февраля , 2024",
  ...
  {
    id: 14,
    name: "Создайте простое приложение для цифровых часов, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "5 февраля , 2024",
  ...
  {
    id: 15,
    name: "Создайте простое приложение для веб-сайта Bolby, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "25 января, 2024",
  ...
  {
    id: 16,
    name: "Создайте простое приложение для расчета веса, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "14 января, 2024",
  ...
  {
    id: 17,
    name: "Создайте простое приложение для анимации кликов курсора, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "13 января, 2024",
  ...
  {
    id: 18,
    name: "Создайте простое приложение случайного шестнадцатеричного цвета, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "10 января, 2024",
  ...
  {
    id: 19,
    name: "Создайте простое приложение для портфолио, используя Html css js",
    tags: ["Html", "css", "js"],
  ...
  {
    id: 20,
    name: "Создайте простое приложение Elias React Tailwind, используя Html css js",
    tags: ["React", "css"],
    date: "14 Декабря , 2023",
  ...
  {
    id: 21,
    name: "Создайте простое приложение-генератор случайных цветов, используя Html css js",
    tags: ["Html", "css"],
    date: "4 Декабря , 2023",
  ...
  {
    id: 22,
    name: "Создайте простое приложение для анимации индикатора выполнения, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "6 Декабря , 2023",
  ...
  {
    id: 23,
    name: "Создайте простое приложение с длиной буквы, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "6 Декабря , 2023",
  ...
  {
    id: 24,
    name: "Создайте простое приложение-генератор цветов RGB с использованием Html css js",
    tags: ["Html", "css", "js"],
    date: "6 Декабря , 2023",
  ...
  {
    id: 25,
    name: "Создайте простое приложение, соответствующее капче, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "6 Декабря , 2023",
  ...
  {
    id: 26,
    name: "Создайте простое приложение для событий мыши, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "6 Декабря , 2023",
  ...
  {
    id: 27,
    name: "Создайте простое приложение с формой рейтинга, используя Html css js",
    tags: ["Html", "css", "js"],
    date: "3 Декабря , 2023",
  ...
  {
    id: 28,
    name: "Создайте простое приложение Alex React с использованием React css ",
    tags: ["React", "css"],
    date: "6 Декабря , 2023",
  ...
  {
    id: 29,
    name: "Создайте простое приложение для ввода пользовательского диапазона с помощью React css ",
    tags: ["Html", "css", "Js"],
    date: "28 марта , 2024",
  ...
  {
    id: 30,
    name: "Создайте простое приложение React Jone, используя React css ",
    tags: ["React", "css"],
    date: "20 ноября , 2023",
  ...
  {
    id: 31,
    name: "Создайте простой веб-сайт с помощью приложения Etimad с помощью Html css js ",
    tags: ["Html", "css", "Js"],
    date: "21 ноября , 2023",
  ...
  {
    id: 32,
    name: "Создайте простое приложение Pixology для веб-сайта с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "22 ноября , 2023",
  ...
  {
    id: 33,
    name: "Создайте простой веб-сайт Foodle с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "23 ноября , 2023",
  ...
  {
    id: 34,
    name: "Создайте простой веб-сайт. Приложение «Поделитесь ссылками в социальных сетях» с использованием Html css js. ",
    tags: ["Html", "css", "Js"],
    date: "26 ноября , 2023",
  ...
  {
    id: 35,
    name: "Создайте простой веб-сайт с приложением Landio, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "24 ноября , 2023",
  ...
  {
    id: 36,
    name: "Создайте простое приложение таймера обратного отсчета для веб-сайта с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "26 ноября , 2023",
  ...
  {
    id: 37,
    name: "Создайте простое приложение NavBar, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "26 ноября , 2023",
  ...
  {
    id: 38,
    name: "Создайте простое приложение Tolmol, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "28 ноября , 2023",
  ...
  {
    id: 39,
    name: "Создайте простое приложение с часами, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "28 ноября , 2023",
  ...
  {
    id: 40,
    name: "Создайте простое приложение с цифровыми часами, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "28 ноября , 2023",
  ...
  {
    id: 41,
    name: "Создайте приложение простой формы, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "28 ноября , 2023",
  ...
  {
    id: 42,
    name: "Создайте простое приложение с несколькими вариантами выбора меню с помощью Html css js",
    tags: ["Html", "css", "Js"],
    date: "29 ноября , 2023",
  ...
  {
    id: 43,
    name: "Создайте простое приложение для проверки пароля, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "29 ноября , 2023",
  ...
  {
    id: 44,
    name: "Создайте простое приложение с многоэтапной формой, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "29 ноября , 2023",
  ...
  {
    id: 45,
    name: "Создайте простое приложение-портфолио, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "29 ноября , 2023",
  ...
  {
    id: 46,
    name: "Создайте простое приложение для создания градиентного цвета с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "30 ноября , 2023",
  ...
  {
    id: 47,
    name: "Создайте простое меню действий с настраиваемым приложением для переключения флажков с помощью Html css js ",
    tags: ["Html", "css", "Js"],
    date: "30 ноября , 2023",
  ...
  {
    id: 48,
    name: "Создайте простое приложение для часов, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "30 ноября , 2023",
  ...
  {
    id: 49,
    name: "Создайте простое приложение для секундомера с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "30 ноября , 2023",
  ...
  {
    id: 50,
    name: "Создайте простое приложение для преобразования текста в речь, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "1 января, 2024",
  ...
  {
    id: 51,
    name: "Создайте простое приложение контекстного меню, вызываемое правой кнопкой мыши, с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "1 января, 2024",
  ...
  {
    id: 52,
    name: "Создайте простое приложение для системы звездного рейтинга с помощью Html css js ",
    tags: ["Html", "css", "Js"],
    date: "2 января, 2024",
  ...
  {
    id: 53,
    name: "Создайте простое приложение Costom Select с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "1 Декабря , 2023",
  ...
  {
    id: 54,
    name: "Создайте простое приложение-календарь с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "1 Декабря , 2023",
  ...
  {
    id: 55,
    name: "Создайте простое приложение для проверки электронной почты с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "1 Декабря , 2023",
  ...
  {
    id: 56,
    name: "Создайте простое приложение с перетаскиваемым круговым меню навигации, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "2 Декабря , 2023",
  ...
  {
    id: 57,
    name: "Создайте простое приложение для расчета меню с использованием Html css js ",
    tags: ["Html", "css", "Js"],
    date: "2 Декабря , 2023",
  ...
  {
    id: 58,
    name: "Создайте простое приложение с меню контактов, используя Html css js ",
    tags: ["Html", "css", "Js"],
    date: "2 Декабря , 2023",
  ...
  {
    id: 59,
    name: "Создайте простое приложение Volit, используя Html Tilwind js ",
    tags: ["Html", "Tilwind", "Js"],
    date: "28 ноября , 2023",
  ...
  {
    id: 60,
    name: "Создайте простое приложение Foodcap, используя Html Css js ",
    tags: ["Html", "Css", "Js"],
  ...
  {
    id: 61,
    name: "Создайте простое приложение для еды, используя Html Css js ",
    tags: ["Html", "Css", "Js"],
  ...
  {
    id: 62,
    name: "Создайте простое приложение электронного магазина с помощью Html Bootstrap js ",
  ...
  {
    id: 63,
    name: "Создайте простое приложение CISECO, используя Html Css js ",
    tags: ["Html", "Css", "Js"],
  ...
  {
    id: 64,
    name: "Создайте простое приложение PLANTEX, используя HTML Css jQuery ",
  ...
  {
    id: 65,
    name: "Создайте простое приложение BAILO, используя Html Css Js ",
    tags: ["Html", "Css", "Js"],
  ...
  {
    id: 66,
    name: "Создайте простое приложение FIXPRO, используя Html Scss Js ",
    tags: ["Html", "Scss", "Js"],
  ...
  {
    id: 67,
    name: "Создайте простое образовательное приложение, используя Html Scss Js ",
    tags: ["Html", "Scss", "Js"],
  ...
  {
    id: 68,
    name: "Создайте простое приложение Dreams, используя Html css Js ",
    tags: ["Html", "css", "Js"],
    date: "27 октября, 2023",
  ...
  {
    id: 69,
    name: "Создайте простое приложение BARBER, используя HTML CSS Js ",
    tags: ["Html", "css", "Js"],
  ...
  {
    id: 70,
    name: "Создайте простое приложение Educe с использованием HTML CSS Js ",
    tags: ["Html", "css", "Js"],
  ...
  {
    id: 72,
    name: "Создайте простое приложение для чтения книг с помощью Html css JQuery ",
    tags: ["Html", "css", "JQuery"],
    date: "2 ноября , 2023",
  ...
  {
    id: 73,
    name: "Создайте простое приложение BURGER с помощью Html Tilwind Js ",
    tags: ["Html", "Tilwind", "Js"],
    date: "4 ноября , 2023",
  ...
  {
    id: 75,
    name: "Создайте простое приложение Dizme, используя Html Css Js ",
    tags: ["Html", "Css", "Js"],
    date: "7 ноября , 2023",
  ...
  {
    id: 77,
    name: "Создайте простое автомобильное приложение с помощью Html Tilwind Js ",
    tags: ["Html", "Tilwind", "Js"],
    date: "11 ноября , 2023",
  ...
  {
    id: 78,
    name: "Создайте простое приложение Elmiz, используя Html Css Js",
    tags: ["Html", "Css", "Js"],
    date: "13 ноября , 2023",
  ...
  {
    id: 79,
    name: "Создайте простое приложение для присоединения, используя Html Css Js ",
    tags: ["Html", "Css", "Js"],
    date: "16 ноября , 2023",
  ...
  {
    id: 80,
    name: "Создайте простое приложение Creway, используя Html Css Js ",
    tags: ["Html", "Css", "Js"],
    date: "19 ноября , 2023",
  ...
  {
    id: 81,
    name: "Создайте простое приложение для рисования с использованием Html Css Js ",
    tags: ["Html", "Css", "Js"],
    date: "22 ноября , 2023",
  ...
  {
    id: 82,
    name: "Создайте простое приложение Bingles, используя Html Css Js ",
    tags: ["Html", "Css", "Js"],
    date: "25 ноября , 2023",
  ...
  {
    id: 83,
    name: "Создайте простое приложение для еды, используя React Css Redux ",
